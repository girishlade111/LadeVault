...
], function (h, Pages, Msg) {

    return function () {
        document.title = 'Contact — LadeVault';

        // ── Brand-accurate SVG icon paths (Lucide / Simple Icons) ────────────
        // Mail — Lucide "Mail" (stroke-based, no fill)
        var SVG_MAIL = function () {
            return h('svg.cp-contact-icon-svg', {
        ...
        // GitHub — Simple Icons official path (fill-based, single path)
        var SVG_GITHUB = function () {
            return h('svg.cp-contact-icon-svg', {
                xmlns: 'http://www.w3.org/2000/svg',
                viewBox: '0 0 24 24',
                fill: 'currentColor',
        ...
        // LinkedIn — Simple Icons official path (fill-based)
        var SVG_LINKEDIN = function () {
            return h('svg.cp-contact-icon-svg', {
                xmlns: 'http://www.w3.org/2000/svg',
                viewBox: '0 0 24 24',
                fill: 'currentColor',
        ...
        // Instagram — Simple Icons official path (fill-based)
        var SVG_INSTAGRAM = function () {
            return h('svg.cp-contact-icon-svg', {
                xmlns: 'http://www.w3.org/2000/svg',
                viewBox: '0 0 24 24',
                fill: 'currentColor',
        ...
        var makeCard = function (opts) {
            // opts: { iconFn, label, value, href, iconClass, target }
            var iconWrapper = h('div.cp-contact-icon-badge' + (opts.iconClass ? '.' + opts.iconClass : ''), [
                opts.iconFn()
            ]);

            var textBlock = h('div.cp-contact-card-text', [
            ...
            return h('a.cp-contact-card', attrs, [
                iconWrapper,
                textBlock,
            ]);
        };
        ...
        var cards = [
            makeCard({
                iconFn:    SVG_MAIL,
                iconClass: 'cp-contact-icon-mail',
                label:     'Email',
            ...
            makeCard({
                iconFn:    SVG_GITHUB,
                iconClass: 'cp-contact-icon-github',
                label:     'Bug report',
            ...
            makeCard({
                iconFn:    SVG_LINKEDIN,
                iconClass: 'cp-contact-icon-linkedin',
                label:     'LinkedIn',
                value:     'linkedin.com/in/girish-lade',
                href:      'https://www.linkedin.com/in/girish-lade/',
            }),
            makeCard({
                iconFn:    SVG_INSTAGRAM,
                iconClass: 'cp-contact-icon-instagram',
                label:     'Instagram',
                value:     '@girish_lade_',
        ...
        return h('div#cp-main', [
            ...
            h('main.cp-contact-main', [
                h('div.cp-contact-hero', [
                    ...
                    h('p.cp-contact-hint', 'For feature requests, bug reports, or to say hello.'),
                ]),
